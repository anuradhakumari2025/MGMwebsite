  ...
  return (
    <>
      <EngineeringTemplate
        ...
        pso={[
          "Passout Students of Computer Science and Engineering program should be able to Apply knowledge of core courses andemerging areasincluding Data Science, AI/ML, Cloud Computing, Information security, Image Processingfor solving real life problems.",
        ...
        peos={[
          "Graduates of Computer Science & Engineering employed shouldhave abiliy to Analyze Computer Science & Engineering techniques, relate them with real life problems and provide solutions that are technically sound, economically viable and socially acceptable.",
          " Utilizeaquired programing, analytical, design and implementation skill formulate and solve computational problems.",
          " Evolve as competent professionals, researchers and entrepreneurs having collaborative and leadership skills with effective communicationabilities to pursue appropriate career options and become capable of working in multi-disciplinary environment. ",
          "Excel as socially committed Computer Engineers having goodethical and human values.",
        ]}
        img1={"/comp1.jpg"}
        img2={"/comp3.jpg"}
        img3={"/comp4.jpg"}
